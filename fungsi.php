...
//	include('koneksi.php');
//	$query  = "SELECT id_hp FROM data_hp ORDER BY id";
//	$result = mysqli_query($koneksi, $query);
//
//	while ($row = mysqli_fetch_array($result)) {
//		$listID[] = $row['id'];
...
//	include('koneksi.php');
//	$query  = "SELECT nama_hp FROM data_hp ORDER BY id";
//	$result = mysqli_query($koneksi, $query);
//
//	while ($row = mysqli_fetch_array($result)) {
//		$nama[] = $row['nama'];
...
function showTabelPerbandingan($jenis,$kriteria) {
	...
	<div id="tabel-perbandingan-container">
...
<!--			<br><br><input class="ui submit button" type="submit" name="submit" value="SUBMIT">-->
			<button type="submit" class="waves-effect waves-light btn" name="submit" value="SUBMIT" style="margin-bottom:46px;">Submit Kriteria</button>

		</form>


		<script type="text/javascript">
            $('#tabel-perbandingan-container .ui.radio.checkbox')
                .checkbox()
            ;
		</script>
		<script type="text/javascript">
            $('#tabel-perbandingan-container .message .close')
                .on('click', function () {
                    $(this)
                        .closest('.message')
                        .transition('fade')
