    ...
    <!-- Body Start -->
		...
		<div id="index-banner" class="parallax-container">
			<div class="section no-pad-bot">
				<div class="container">
					<h1 class="header jarak center white-text" style="font-size: 40px; text-shadow: 2px 2px 5px black;; text-shadow: 2px 2px 5px black;">SISTEM PENDUKUNG KEPUTUSAN MENGGUNAKAN METODE TOPSIS</h1>
					<div class="row center">
						<h5 class="header jarak-button col s12 light" style="margin-bottom: 0px; font-size: 26px">PEMILIHAN SMARTPHONE</h5>
					</div>
					<div class="row center" \>
								<a href="rekomendasi.php" id="download-button" class="waves-effect waves-light btn-large" style="margin-top: 40px; background-color:rgb(87, 139, 217); background-color:rgb(87, 139, 217)">Pilih Rekomendasi</a>
							</div>
				</div>
			</div>
