...
<head>
	...
	<meta name="description"
		content="Leppi adalah aplikasi Sistem Pendukung Keputusan Laptop berbasis Metode Weight Product">
	<!--Test-->
...
=======
	...
	<div id="index-banner" class="parallax-container">
		<div class="section no-pad-bot">
			<div class="container">
				<h1 class="header jarak center white-text" style="font-size: 40px">SISTEM PENDUKUNG KEPUTUSAN
					MENGGUNAKAN METODE TOPSIS</h1>
				<div class="row center">
					<h5 class="header jarak-button col s12 light" style="margin-bottom: 0px; font-size: 26px">PEMILIHAN
						SMARTPHONE</h5>
				</div>
				<div class="row center" \>
					<a href="rekomendasi-midrange.php" id="download-button" class="waves-effect waves-light btn-large"
						style="margin-top: 40px">Pilih Rekomendasi HP Mid-Range</a>
				</div>
				<div class="row center" \>
					<a href="rekomendasi-flagship.php" id="download-button" class="waves-effect waves-light btn-large"
						style="margin-top: 40px">Pilih Rekomendasi HP Flagship</a>
				</div>
			</div>
>>>>>>> 3ff536069a8e31a52e5d98ee22814e890d790a09
		</div>
		    ...
		    <div class="section-card" style="padding: 36px 0px">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP. Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Sistem Informasi UPNVJT. </p>
						</div>
			    	<div class="col s6">
			...
			<div class="section-card" style="padding: 36px 0px">
				<div class="row">
					<div class="col s6">
						...
						<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan
							Smartphone ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP. Sistem ini
							dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Sistem Informasi
							UPNVJT. </p>
					</div>
					<div class="col s6">
						<center>
						...
						<p style="text-align: justify; padding-left: 16px;">Metode yang digunakan adalah metode TOPSIS.
							Metode TOPSIS adalah salah satu metode penyelesaian pada sistem pendukung keputusan. Metode
							ini mengevaluasi beberapa alternatif terhadap sekumpulan atribuat atau kriteria, dimana
...
>>>>>>> 3ff536069a8e31a52e5d98ee22814e890d790a09
	...
	<div id="about" class="modal">
		<div class="modal-content">
			<h4>Tentang</h4>
			<p>Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode TOPSIS yang dibangun menggunakan
				bahasa PHP.
				Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Sistem Informasi
				UPNVJT <br>
				<br>
			</p>
		</div>
